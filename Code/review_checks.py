...
# Deterministic review implementation constants are kept here rather than in
# config.py because they are not run-time tuning controls.
REVIEW_VERSION = 'reasoning-label-consistency-v9-bilateral-side-fix'

EXCLUSION_PHRASES = ('does not qualify',
 'do not qualify',
 'not qualify',
 'non-qualifying',
 'not enough',
...
POSITIVE_REASONING_PHRASES = ('qualifies for',
 'warrants',
 'is labeled',
 'are labeled',
 'should be labeled',
...
SUBDURAL_EXTRA_AXIAL_REVIEW_TERMS = ('subdural hematoma',
...
SUBARACHNOID_REVIEW_TERMS = ('subarachnoid hemorrhage', 'subarachnoid haemorrhage', 'subarachnoid blood', 'sah')

SUBDURAL_SCAN_FIELDS = (('CT_Report', 'CT report'),
 ('New_CT_Report', 'sanitized CT report'),
 ('MRI_Report', 'MRI report'),
 ('CTA_Report', 'CTA brain-window text'),
 ('CTP_Report', 'CTP context text'))

LABEL_VARIANTS = {'RMCA': ['rmca', 'right mca', 'right middle cerebral', 'right m1', 'right m2', 'right m3', 'right m4'],
 ...
 'LVA': ['lva',
         ...
         'left v3',
         'left v4',
         'left intradural vertebral'],
 'RICA': ['rica',
          'right ica',
          'right internal carotid',
          'right carotid terminus',
          'right intracranial carotid'],
...
LABEL_SIDE_TERRITORY = {'RMCA': ('right', 'MCA'),
 'LMCA': ('left', 'MCA'),
 'RACA': ('right', 'ACA'),
 'LACA': ('left', 'ACA'),
 'RPCA': ('right', 'PCA'),
...
FIELD_REASONING_PAIRS = [('CT_Original_GT', 'CT_Original_GT_reasoning', 'CT original'),
...
CONFIDENCE_FIELDS = [('CT_Original_GT', 'CT original'),
 ('CT_GT', 'CT'),
 ('CTA_GT', 'CTA'),
 ('CTP_GT', 'CTP'),
